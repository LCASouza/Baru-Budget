...
select hasnt_column('public', 'recurring_incomes', 'credit_card_id', 'a recurring income never uses a card');
select has_column('public', 'transactions', 'fixed_expense_id', 'transactions.fixed_expense_id exists');
select has_column('public', 'transactions', 'recurring_income_id', 'transactions.recurring_income_id exists');
select has_column('public', 'transactions', 'recurrence_month', 'transactions.recurrence_month exists');
select has_index('public', 'transactions', 'transactions_fixed_expense_month_key', 'transactions has the fixed expense month index');
select index_is_unique('public', 'transactions', 'transactions_fixed_expense_month_key', 'the fixed expense month index is unique');
select has_index('public', 'transactions', 'transactions_recurring_income_month_key', 'transactions has the recurring income month index');
select has_function('public', 'generate_recurrences', array['uuid', 'date'], 'generate_recurrences exists');
select policies_are('public', 'fixed_expenses', array['fixed_expenses_select_visible', 'fixed_expenses_insert_manage', 'fixed_expenses_update_manage', 'fixed_expenses_delete_manage'], 'fixed_expenses policies');
select policies_are('public', 'recurring_incomes', array['recurring_incomes_select_visible', 'recurring_incomes_insert_manage', 'recurring_incomes_update_manage', 'recurring_incomes_delete_manage'], 'recurring_incomes policies');
