...
select has_enum('public', 'financing_system', 'financing_system enum exists');
select enum_has_labels('public', 'financing_system', array['PRICE', 'SAC'], 'financing_system labels');
select has_table('public', 'financings', 'financings table exists');
select col_not_null('public', 'financings', 'system', 'financings.system is not null');
select col_type_is('public', 'financings', 'interest_rate', 'numeric(9,6)', 'financings.interest_rate is numeric(9,6)');
select col_type_is('public', 'financings', 'financed_amount', 'numeric(14,2)', 'financings.financed_amount is numeric(14,2)');
select fk_ok('public', 'financings', 'account_id', 'public', 'accounts', 'id', 'financings.account_id references accounts');
select fk_ok('public', 'financings', 'category_id', 'public', 'categories', 'id', 'financings.category_id references categories');
select has_index('public', 'financings', 'financings_owner_idx', 'financings has the owner index');
select has_column('public', 'transactions', 'financing_id', 'transactions.financing_id exists');
select has_column('public', 'transactions', 'financing_installment_number', 'transactions.financing_installment_number exists');
select has_index('public', 'transactions', 'transactions_financing_down_payment_key', 'transactions has the down payment index');
select has_index('public', 'transactions', 'transactions_financing_installment_key', 'transactions has the financing instalment index');
select has_function('public', 'financing_monthly_rate', 'financing_monthly_rate exists');
select has_function('public', 'financing_installment_amounts', 'financing_installment_amounts exists');
select has_function('public', 'generate_financing_schedule', 'generate_financing_schedule exists');
select has_function('public', 'validate_financing_references', 'validate_financing_references exists');
select has_trigger('public', 'financings', 'financings_set_audit_on_insert', 'financings has the insert audit trigger');
select has_trigger('public', 'financings', 'financings_set_audit_on_update', 'financings has the update audit trigger');
select has_trigger('public', 'financings', 'financings_validate_references', 'financings has the reference validation trigger');
select function_privs_are('public', 'generate_financing_schedule', array['uuid', 'boolean'], 'anon', array[]::text[], 'anon cannot execute generate_financing_schedule');
select function_privs_are('public', 'validate_financing_references', array[]::text[], 'authenticated', array[]::text[], 'authenticated cannot execute validate_financing_references');
select has_enum('public', 'loan_interest_model', 'loan_interest_model enum exists');
select enum_has_labels('public', 'loan_interest_model', array['SIMPLE', 'PRICE'], 'loan_interest_model labels');
select has_enum('public', 'interest_period', 'interest_period enum exists');
select has_table('public', 'loans', 'loans table exists');
select col_not_null('public', 'loans', 'interest_model', 'loans.interest_model is not null');
select col_type_is('public', 'loans', 'interest_rate', 'numeric(9,6)', 'loans.interest_rate is numeric(9,6)');
select has_column('public', 'transactions', 'loan_id', 'transactions.loan_id exists');
select has_column('public', 'transactions', 'loan_installment_number', 'transactions.loan_installment_number exists');
select has_index('public', 'transactions', 'transactions_loan_disbursement_key', 'transactions has the loan disbursement index');
select has_index('public', 'transactions', 'transactions_loan_installment_key', 'transactions has the loan instalment index');
select has_function('public', 'loan_monthly_rate', 'loan_monthly_rate exists');
select has_function('public', 'loan_installment_amounts', 'loan_installment_amounts exists');
select has_function('public', 'generate_loan_schedule', array['uuid', 'boolean'], 'generate_loan_schedule exists');
select policies_are('public', 'loans', array['loans_select_visible', 'loans_insert_manage', 'loans_update_manage', 'loans_delete_manage'], 'loans policies');
